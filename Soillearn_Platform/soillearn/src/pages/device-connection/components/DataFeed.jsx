  ...
  const getValueColor = (type, value) => {
    switch (type) {
      ...
      case 'temperature':
        ...
        return 'text-error';
      case 'humidity':
        if (value >= 40 && value <= 60) return 'text-success';
        if (value >= 30 && value <= 70) return 'text-warning';
        return 'text-error';
      case 'light':
        if (value >= 1000 && value <= 3000) return 'text-success';
        if (value >= 500 && value <= 4000) return 'text-warning';
        return 'text-error';
      case 'pressure':
